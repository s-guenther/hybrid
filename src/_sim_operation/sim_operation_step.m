function sim_results = sim_operation_step(signal, control, ...
                                          state, bw_int, opt)
% SIM_OPERATION_STEP specialized simulation for signal type 'step'
%
% SIM_OPERATION_STEP applies the control strategy to the signal at a
% specific cut. It is a specialized function of SIM_OPERATION for signals
% of type 'step'.
%
% SIM_RESULTS = SIM_OPERATION_STEP(SIGNAL, CONTROL, STATE, BW_INT, OPT)
...
sigfhandle = step_to_fhandle(signal, opt);
