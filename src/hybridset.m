...
%   continuous solver. Default is odeset('RelTol', 1e-5, 'MaxStep', 1e-1).
%
% amv_rel_tol - Average mean value relative tolerance. Default is 1e-5. The
%   input signal has to have an AMV of zero. amv_rel_tol defines the allowed
%   relative deviation from this requirement.
% int_neg_rel_tol - Negative integral relative tolerance. Default is 1e-5.
...
%   of this requirement.
% int_zero_rel_tol - Zero integral relative tolerance. Default is 1e-5. The
...
%   1e-5. If the control for a specific case is simulated to view or verify a
